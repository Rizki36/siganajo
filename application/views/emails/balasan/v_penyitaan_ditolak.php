													...
													<div>
														<table align="center" style="margin-top:30px;margin-bottom:30px;color:#1a1a1a">
															<tbody>
																...
																<tr>
																	<td>
																		<div style="margin-bottom: 1rem;">
																			<label for="">Nomor Surat Penolakan</label>
																...
																<tr>
																	<td align="center">
																		<a href="<?= $link_detail ?>" rel="noopener noreferrer" style="font-family:Verdana,Sans-Serif;background-color:#492682;border-radius:3px;color:#ffffff;display:inline-block;font-size:14px;line-height:50px;text-align:center;text-decoration:none;width:300px;margin-top:20px;margin-bottom:20px" target="_blank"><strong>Lihat Detail</strong></a>
																	</td>
																</tr>
															</tbody>
														</table>
