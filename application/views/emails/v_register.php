													...
													<div>
														<table align="center" style="margin-top:30px;margin-bottom:30px;color:#1a1a1a">
															<tbody>
																<tr>
																	<td align="center">
																		<p style="font-size:28px;line-height:48px;margin-top:0px;margin-bottom:20px"><b>User Baru</b></p>
																	</td>
																</tr>
																...
																<tr>
																	<td align="center">Pastikan login terlebih dahulu untuk mengakses link dibawah.</td>
																</tr>
																<tr>
																	<td align="center">
																		<a href="<?= $link ?>" rel="noopener noreferrer" style="font-family:Verdana,Sans-Serif;background-color:#492682;border-radius:3px;color:#ffffff;display:inline-block;font-size:14px;line-height:50px;text-align:center;text-decoration:none;width:300px;margin-top:20px;margin-bottom:20px" target="_blank"><strong>Verifikasi User</strong></a>
																	</td>
																</tr>
															</tbody>
														</table>
